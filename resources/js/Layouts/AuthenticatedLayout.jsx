    ...
    return (
        <div className="min-h-screen bg-gray-100">
            <nav className="bg-white border-b border-gray-100">
                ...
                {/* Bagian ini sudah benar (full-width) */}
                <div className="px-4 sm:px-6 lg:px-8"> 
                    <div className="flex justify-between h-16">
                        ...
                        {/* Dropdown User Kanan (sudah benar) */}
            ...
            {/* Konten Header (sudah benar, full-width) */}
            {header && (
            ...
            {/* 👇 ========================================== 👇 */}
            {/* BAGIAN INI DIPERBAIKI (Wrapper 'py-12' dihapus) */}
            {/* 👇 ========================================== 👇 */}
            <main>{children}</main>
            {/* 👆 ========================================== 👆 */}
